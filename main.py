...
## QQ酷推值
    ...
    if str(key) == '0':
        key = ''
    # 用户名（格式为 13800138000）
    user = '13197937630#17817953161#19129563582#19808051642#15711970792#15711973161#15712040161'
    # 登录密码
    passwd = 'xiefeiguang888#xiefeiguang888#xiefeiguang888#jian823823#xiefeiguang888#xiefeiguang888#xiefeiguang888'
